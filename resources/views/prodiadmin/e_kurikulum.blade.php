    ...
    <section class="content">
        <div class="box">
            ...
            <div class="card card-primary card-outline">
                    <div class="card-body">
                        @foreach ($objek as $ds)
                            <form action="/prodiadmin/u_kurikulum/{{$ds->id}}" method="POST" enctype="multipart/form-data">
                        @endforeach
                        @csrf
                        @method('put')
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label for="nama_prodi">Nama Prodi</label>
                                    <input type="text" id="nama_prodi" name="nama_prodi" class="form-control" value="{{ $prodi->nama_prodi }}" readonly>
                        </div>
