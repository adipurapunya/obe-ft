    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="m-0">Pejabat Pengesah <a href="{{url('prodiadmin/a_pengesah')}}"><div class="btn btn-small btn-info text-center" style="float:right; color:white"> Tambah Data</div></a></h5>
            </div>
            <div class="card-body">
