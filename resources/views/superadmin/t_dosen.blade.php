    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="m-0">Data Dosen <a href="{{url('superadmin/a_dosen')}}"><div class="btn btn-small btn-primary text-center" style="float:right"> Tambah Data</div></a></h5>
                    ...
                    <tbody>
                        @foreach($data as $ds)
                            <tr>
                                ...
                                <td>{{ $ds->nama_prodi }}</td>
                                <td>
                                    <a href="{{ url('superadmin/e_dosen/'.Crypt::encryptString($ds->id), [])}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
